const NavBar = () => {
  return (
    <div>
      <div className="border border-indigo-600 fixed bottom-0 left-0 w-400 h-full text-4xl text-center flex flex-col justify-between bg-pink-300 bg-opacity-75">
        <div className="flex-none grid grid-col-1 space-y-2.5">
          <a href="https://guide.shielkwamm.com">⧊</a>
          <a href="https://acktueli.com">◫</a>
        </div>
        <div className="flex-grow text-center text-2xl align-middle m-1"  style={{writingMode: "vertical-rl", textOrientation: "mixed"}}>
          || ship ||
        </div>
