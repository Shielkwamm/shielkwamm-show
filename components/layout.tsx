...
export default function Layout({ children }) {
  ...
  return (
    <>
      ...
      <YTWin title={"🤞"}>
      <iframe width="560" height="315" src="https://www.youtube.com/embed/AkdrDxLb-fY" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>'
      </YTWin>
      </div>
    </>
  )
