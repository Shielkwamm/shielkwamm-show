...
(lib.speech = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:106.8,regY:32.1,scaleX:1,scaleY:1,x:100.7,y:29.05,alpha:1},9,cjs.Ease.quintOut).wait(7).to({alpha:0},5).wait(1));
...
p.nominalBounds = new cjs.Rectangle(97.1,85,103,-14.599999999999994);
// library properties:
lib.properties = {
